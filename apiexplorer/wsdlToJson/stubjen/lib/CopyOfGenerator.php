		...
		else
		{
			foreach ($inpt->members as $mbr)
			{
				...
				if(!$mbr->isSimpleType)
				{
					...
					$namespc1 = 'http://svcs.paypal.com/types/ap:'.$type;
					$namespc2 = 'http://svcs.paypal.com/types/common:'.$type;
					if(!empty($this->_dataTypes[$namespc1]))
					{
						$typ = $namespc1;
					}
					else
