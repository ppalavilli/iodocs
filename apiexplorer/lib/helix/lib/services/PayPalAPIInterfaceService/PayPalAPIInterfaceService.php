...
class AbstractRequestType  {
	...
	public function toXMLString() {
		...
		if($this->DetailLevel != null) {
				...
				//prop is not a value
				$str .= '<ebl:DetailLevel>'. $this->DetailLevel . '</ebl:DetailLevel>';
...
class BusinessInfoType  {
	...
	/**
	 * Businessâ€™s primary telephone number Character length and
...
class BusinessOwnerInfoType  {
	...
	/**
	 * Business ownerâ€™s home telephone number Character length
	...
	/**
	 * Business ownerâ€™s mobile telephone number Character length
	 * and limitations: 32 alphanumeric characters
	 *@access public
	 *@var string
	 */ 
	...
	/**
	 * Business ownerâ€™s social security number Character length
...
class BankAccountDetailsType  {
	...
	/**
	 * Merchantâ€™s bank routing number Character length and
	...
	/**
	 * Merchantâ€™s bank account number Character length and
...
class GetBoardingDetailsResponseDetailsType  {
	...
	/**
	 * Reason for merchantâ€™s cancellation of sign-up. Character
...
class APICredentialsType  {
	...
	/**
	 * Merchantâ€™s PayPal API usernameCharacter length and
	...
	/**
	 * Merchantâ€™s PayPal API passwordCharacter length and
	...
	/**
	 * Merchantâ€™s PayPal API signature, if one exists. Character
	...
	/**
	 * Merchantâ€™s PayPal API certificate in PEM format, if one
	...
	/**
	 * Merchantâ€™s PayPal API authentication mechanism. Auth-None:
...
class AddressVerifyRequestType  extends AbstractRequestType  {
	...
	/**
	 * First line of buyerâ€™s billing or shipping street address
	 ...
	 * Alphanumeric plus - , . â€˜ # \ Whitespace and case of input
	 * value are ignored.
	 *@access public
	 *@var string
	 */ 
...
class DoDirectPaymentResponseType  extends AbstractResponseType  {
	 ...
	 * International â€œAâ€�Address only (no ZIP) CInternational
	 * â€œNâ€� None DInternational â€œXâ€� Address and Postal Code
	 * E Not allowed for MOTO (Internet/Phone) transactions Not
	 * applicable F UK-specific â€œXâ€�Address and Postal Code G
	 * Global Unavailable Not applicable I International
	 * UnavailableNot applicable N NoNone PPostal (International
	 * â€œZâ€�)Postal Code only (no Address) RRetryNot applicable S
